...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    * */
    private void initBook(SQLiteDatabase db) {
        ContentValues value = new ContentValues();
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(),R.drawable.duliri);
        ...
        Bitmap bitmap2 = BitmapFactory.decodeResource(context.getResources(),R.drawable.mgjjx);
        byte[] photo2 = PrefUtils.bmpToByteArray(bitmap2);
        ...
        value2.put("photo",photo2);
        db.insert(BOOKINFO, null, value2);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value3 = new ContentValues();
        Bitmap bitmap3 = BitmapFactory.decodeResource(context.getResources(),R.drawable.szsczg);
        byte[] photo3 = PrefUtils.bmpToByteArray(bitmap3);
        ...
        value3.put("photo",photo3);
        db.insert(BOOKINFO, null, value3);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value4 = new ContentValues();
        Bitmap bitmap4 = BitmapFactory.decodeResource(context.getResources(),R.drawable.scfjh);
        byte[] photo4 = PrefUtils.bmpToByteArray(bitmap4);
        ...
        value4.put("photo",photo4);
        db.insert(BOOKINFO, null, value4);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value5 = new ContentValues();
        Bitmap bitmap5 = BitmapFactory.decodeResource(context.getResources(),R.drawable.aidehua);
        byte[] photo5 = PrefUtils.bmpToByteArray(bitmap5);
        ...
        value5.put("photo",photo5);
        db.insert(BOOKINFO, null, value5);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value6 = new ContentValues();
        Bitmap bitmap6 = BitmapFactory.decodeResource(context.getResources(),R.drawable.dydhk);
        byte[] photo6 = PrefUtils.bmpToByteArray(bitmap6);
        ...
        value6.put("photo",photo6);
        db.insert(BOOKINFO, null, value6);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value7 = new ContentValues();
        Bitmap bitmap7 = BitmapFactory.decodeResource(context.getResources(),R.drawable.wzbh);
        byte[] photo7 = PrefUtils.bmpToByteArray(bitmap7);
        ...
        value7.put("photo",photo7);
        db.insert(BOOKINFO, null, value7);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value8 = new ContentValues();
        Bitmap bitmap8 = BitmapFactory.decodeResource(context.getResources(),R.drawable.ysqa);
        byte[] photo8 = PrefUtils.bmpToByteArray(bitmap8);
        ...
        value8.put("photo",photo8);
        db.insert(BOOKINFO, null, value8);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value9 = new ContentValues();
        Bitmap bitmap9 = BitmapFactory.decodeResource(context.getResources(),R.drawable.ysrs);
        byte[] photo9 = PrefUtils.bmpToByteArray(bitmap9);
        ...
        value9.put("photo",photo9);
        db.insert(BOOKINFO, null, value9);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value10 = new ContentValues();
        Bitmap bitmap10 = BitmapFactory.decodeResource(context.getResources(),R.drawable.gdrase);
        byte[] photo10 = PrefUtils.bmpToByteArray(bitmap10);
        ...
        value10.put("summary", "这是那种少有的既可以在读书俱乐部里引起激烈争论，又可以在飞机上消磨几小时时光的书。——读者评论\n" +
                ...
                "-\n" +
                "勒翰有着绝妙的语言表达方式。情节紧密交织，节奏干脆利落，角色人格丰富。从各种角度来看，《夜色人生》都是一部了不起的小说。——读者评论");
        value10.put("photo",photo10);
        db.insert(BOOKINFO, null, value10);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value11 = new ContentValues();
        Bitmap bitmap11 = BitmapFactory.decodeResource(context.getResources(),R.drawable.rljs);
        byte[] photo11 = PrefUtils.bmpToByteArray(bitmap11);
        ...
        value11.put("photo",photo11);
        db.insert(BOOKINFO, null, value11);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value12 = new ContentValues();
        Bitmap bitmap12 = BitmapFactory.decodeResource(context.getResources(),R.drawable.wwcs);
        byte[] photo12 = PrefUtils.bmpToByteArray(bitmap12);
        ...
        value12.put("photo",photo12);
        db.insert(BOOKINFO, null, value12);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value13 = new ContentValues();
        Bitmap bitmap13 = BitmapFactory.decodeResource(context.getResources(),R.drawable.jyzhd);
        byte[] photo13 = PrefUtils.bmpToByteArray(bitmap13);
        ...
        value13.put("photo",photo13);
        db.insert(BOOKINFO, null, value13);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value14 = new ContentValues();
        Bitmap bitmap14 = BitmapFactory.decodeResource(context.getResources(),R.drawable.bainaingudu);
        byte[] photo14 = PrefUtils.bmpToByteArray(bitmap14);
        ...
        value14.put("photo",photo14);
        db.insert(BOOKINFO, null, value14);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value15 = new ContentValues();
        Bitmap bitmap15 = BitmapFactory.decodeResource(context.getResources(),R.drawable.dydnh);
        byte[] photo15 = PrefUtils.bmpToByteArray(bitmap15);
        ...
        value15.put("photo",photo15);
        db.insert(BOOKINFO, null, value15);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value16 = new ContentValues();
        Bitmap bitmap16 = BitmapFactory.decodeResource(context.getResources(),R.drawable.zgldzzds);
        byte[] photo16 = PrefUtils.bmpToByteArray(bitmap16);
        ...
        value16.put("photo",photo16);
        db.insert(BOOKINFO, null, value16);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value17 = new ContentValues();
        Bitmap bitmap17 = BitmapFactory.decodeResource(context.getResources(),R.drawable.wlswn);
        byte[] photo17 = PrefUtils.bmpToByteArray(bitmap17);
        ...
        value17.put("photo",photo17);
        db.insert(BOOKINFO, null, value17);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value18 = new ContentValues();
        Bitmap bitmap18 = BitmapFactory.decodeResource(context.getResources(),R.drawable.jbgjs);
        byte[] photo18 = PrefUtils.bmpToByteArray(bitmap18);
        ...
        value18.put("photo",photo18);
        db.insert(BOOKINFO, null, value18);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value19 = new ContentValues();
        Bitmap bitmap19 = BitmapFactory.decodeResource(context.getResources(),R.drawable.tlbb);
        byte[] photo19 = PrefUtils.bmpToByteArray(bitmap19);
        ...
        value19.put("photo",photo19);
        db.insert(BOOKINFO, null, value19);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value20 = new ContentValues();
        Bitmap bitmap20 = BitmapFactory.decodeResource(context.getResources(),R.drawable.dbcs);
        byte[] photo20 = PrefUtils.bmpToByteArray(bitmap20);
        ...
        value20.put("photo",photo20);
        db.insert(BOOKINFO, null, value20);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value21 = new ContentValues();
        Bitmap bitmap21 = BitmapFactory.decodeResource(context.getResources(),R.drawable.qyx);
        byte[] photo21 = PrefUtils.bmpToByteArray(bitmap21);
        ...
        value21.put("photo",photo21);
        db.insert(BOOKINFO, null, value21);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value22 = new ContentValues();
        Bitmap bitmap22 = BitmapFactory.decodeResource(context.getResources(),R.drawable.zljsf);
        byte[] photo22 = PrefUtils.bmpToByteArray(bitmap22);
        ...
        value22.put("photo",photo22);
        db.insert(BOOKINFO, null, value22);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value23 = new ContentValues();
        Bitmap bitmap23 = BitmapFactory.decodeResource(context.getResources(),R.drawable.zsnrnjy);
        byte[] photo23 = PrefUtils.bmpToByteArray(bitmap23);
        ...
        value23.put("photo",photo23);
        db.insert(BOOKINFO, null, value23);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value24 = new ContentValues();
        Bitmap bitmap24 = BitmapFactory.decodeResource(context.getResources(),R.drawable.gwdn);
        byte[] photo24 = PrefUtils.bmpToByteArray(bitmap24);
        ...
        value24.put("summary", "美国健康类第一畅销书！\n" +
                ...
                "在你毫无知觉的时候，\n" +
                "已对你的大脑与身体造成永久的损害。");
        value24.put("photo",photo24);
        db.insert(BOOKINFO, null, value24);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value25 = new ContentValues();
        Bitmap bitmap25 = BitmapFactory.decodeResource(context.getResources(),R.drawable.mgttdcf);
        byte[] photo25 = PrefUtils.bmpToByteArray(bitmap25);
        ...
        value25.put("photo",photo25);
        db.insert(BOOKINFO, null, value25);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value26 = new ContentValues();
        Bitmap bitmap26 = BitmapFactory.decodeResource(context.getResources(),R.drawable.chitoufalanxi);
        byte[] photo26 = PrefUtils.bmpToByteArray(bitmap26);
        ...
        value26.put("photo",photo26);
        db.insert(BOOKINFO, null, value26);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value27 = new ContentValues();
        Bitmap bitmap27 = BitmapFactory.decodeResource(context.getResources(),R.drawable.mrdbd);
        byte[] photo27 = PrefUtils.bmpToByteArray(bitmap27);
        ...
        value27.put("photo",photo27);
        db.insert(BOOKINFO, null, value27);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value28 = new ContentValues();
        Bitmap bitmap28 = BitmapFactory.decodeResource(context.getResources(),R.drawable.xhhq);
        byte[] photo28 = PrefUtils.bmpToByteArray(bitmap28);
        ...
        value28.put("photo",photo28);
        db.insert(BOOKINFO, null, value28);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value29 = new ContentValues();
        Bitmap bitmap29 = BitmapFactory.decodeResource(context.getResources(),R.drawable.qbbfbb);
        byte[] photo29 = PrefUtils.bmpToByteArray(bitmap29);
        ...
        value29.put("photo",photo29);
        db.insert(BOOKINFO, null, value29);
        Log.i(TAG, "初始化图书数据成功");

        ContentValues value30 = new ContentValues();
        Bitmap bitmap30 = BitmapFactory.decodeResource(context.getResources(),R.drawable.cmdtzz);
        byte[] photo30 = PrefUtils.bmpToByteArray(bitmap30);
