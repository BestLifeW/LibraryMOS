...
public class C_only_ManagerAdapter extends SwipeMenuAdapter<C_only_ManagerAdapter.BookMangerHolder> {
    ...
    public C_only_ManagerAdapter(Context context, ArrayList<BookBean> list) {
        mList = new ArrayList<>();
    ...
    public View onCreateContentView(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.c_only_item,
                parent, false);
        return view;
    }

    @Override
    public C_only_ManagerAdapter.BookMangerHolder onCompatCreateViewHolder(View realContentView, int viewType) {
        return new BookMangerHolder(realContentView);
    }

    @Override
    public void onBindViewHolder(C_only_ManagerAdapter.BookMangerHolder holder, final int position) {
    ...
    public int getItemCount() {
     ...
     class BookMangerHolder extends RecyclerView.ViewHolder {
         ...
         BookMangerHolder(View itemView) {
            super(itemView);
            book_title = (TextView) itemView.findViewById(R.id.tv_c_only_title);
             iv_bookitem_im = (ImageView) itemView.findViewById(R.id.iv_c_only_im);
             card_view = (CardView) itemView.findViewById(R.id.c_only_item);
         }
    }
}
